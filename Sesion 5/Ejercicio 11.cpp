...
int main(){
	...
	//En este ejercicio depende de como interpretemos la subida salaria, es decir si se aplica primero la
	// subida de 3% y al resultado le incrementamos otro 2% o una sola subida 3 + 2 = 5%
	...
	if((casos_resueltos >= 20) && (casos_resueltos <= 30))
		salario_final += 3; 
	else if(casos_resueltos > 30)
		salario_final += 4; 
	
	salario_final = salario_hora*(salario_final/100) + salario_hora;
